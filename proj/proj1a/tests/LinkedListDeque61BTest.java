...
public class LinkedListDeque61BTest {
    ...
    public void toListTest(){
         ...
         assertThat(lld1.toList()).containsExactly(2007, 10, 8);
    ...
    public void removeFirstTest(){
        ...
        Integer Expected = lld1.removeFirst();
        assertThat(Expected).isEqualTo(2007);
        List<Integer> expectedList = List.of(10, 8);
        assertThat(lld1.toList()).containsExactlyElementsIn(expectedList);
    }
    ...
    public void removeLastTest(){
        ...
        Integer Expected = lld1.removeLast();
        assertThat(Expected).isEqualTo(8);
        List<Integer> expectedList = List.of(2007, 10);
    ...
    public void getTest(){
        ...
        lld1.addLast("World");
        lld1.addLast("Memory");
        lld1.addLast("RustyLake");
        lld1.addLast("Let's make some memories.");
        lld1.addLast("Mr. Owl");
        lld1.addLast("Mr. Crow");

        assertThat(lld1.get(2)).isEqualTo("Memory");
        assertThat(lld1.get(-1)).isEqualTo(null);
        assertThat(lld1.get(5)).isEqualTo("Mr. Owl");
        assertThat(lld1.get(114514)).isEqualTo(null);
    }
    ...
    public void getRecursiveTest(){
        ...
        assertThat(lld1.getRecursive(2)).isEqualTo("Memory");
